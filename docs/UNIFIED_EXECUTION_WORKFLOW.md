...
```bash
python scripts/verification_state.py capture --state evidence/verification-state.json --base origin/main --task-packet evidence/task-packet.json
